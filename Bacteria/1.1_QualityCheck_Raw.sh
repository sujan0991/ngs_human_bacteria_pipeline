...
paired_end="Yes" # set to "Yes" if you want to additionally compare the quality of forward and reverse reads. Applies to paired-end data. Otherwise, provide whatever else, e.g. "No", "gfg", "false" or just leave empty "".
